...
```{r Means steps Calculation, echo = TRUE}
tSteps <- sum(Activity_Data$steps, na.rm = TRUE)
tSteps
```
###2. Histogram of the total number of steps taken each day.
```{r Number of Steps taken per day, fig.height=6, echo = TRUE}
...
```{r Average daily activity pattern, fig.height=6, echo = TRUE}
library(ggplot2)
...
```{r Number of Step taken per day (imputation), fig.height=6, echo = TRUE}
...
### Panel Plot
```{r Panel Plot, fig.height=6, echo=TRUE}
