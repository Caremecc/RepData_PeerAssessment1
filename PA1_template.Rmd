...
```{r Plot_1, fig.height=6, echo = TRUE}
...
```{r Plot_2, fig.height=6, fig.width=6, include=TRUE, echo = TRUE}
library(ggplot2)
...
```{r Plot_3, fig.height=6, echo = TRUE}
...
### Panel Plot
```{r Panel_Plot, fig.height=6, echo=TRUE}
